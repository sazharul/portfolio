...
- Joined client meetings to understand insurance calculation requirements
- Designed database and built CMS/backend
- Implemented insurance calculation logic (core business rules)
- Built admin panel, customer dashboard, REST APIs, mobile app APIs
- Guided junior developer; coordinated with Flutter app developer

...
export const hireServices = [
  {
    ...
    description: "Senior software engineer for product teams building Laravel/PHP backends, APIs, and full-stack features.",
  },
  {
    title: "Fintech & payment systems",
    description: "Payment gateways, transaction workflows, banking integrations, and admin reporting for regulated business logic.",
  },
  {
    title: "E-commerce & analytics",
    description: "Store platforms, event tracking, dashboards, shipping APIs, marketplaces, and data-heavy admin tools.",
  },
  {
    title: "Insurance & enterprise apps",
    description: "Complex business rules, policy systems, inventory, and mobile API backends for long-lived products.",
  },
  {

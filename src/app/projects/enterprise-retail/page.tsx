...
import { EnterpriseRetailPage } from "@/components/case-studies/EnterpriseRetailPage";
...
export default function EnterpriseRetailProjectPage() {
  const project = getProject(SLUG);
  const seo = getCaseStudySeo(SLUG);
  ...
  return (
    <>
      <JsonLd
        data={[
          ...
          getTechArticleJsonLd({
            ...
            about: ["Laravel", "React", "Node.js", "E-commerce"],
          }),
      ...
      />
      <EnterpriseRetailPage project={project} seo={seo} />
    </>
  );
}
